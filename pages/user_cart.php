      ...
      <table class="table table-condensed table-bordered">
          ...
          ?>
              ...
              <tr>
                  ...
                  <td><br><?php  echo $row2['prod_price'].'&nbsp'.'Tk'; ?></td>
                  <td><br><?php echo $row['total'].'&nbsp'.'Tk';?></td>
                  <td>     
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Bogura City">Bogura</option>
                      <option value="Rangpur City">Rangpur</option>
                      ...
                      <option value="Dinajpur City">Dinajpur</option>
                      <option value="Jesspre City">Jesspre</option>
                      <option value="Magura City">Magura</option>
                      <option value="Noakhaili City">Noakhaili</option>
                      </select>  
                      </div>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright text-center">
                    ...
                    </script> Designed and Developed by Omar Faruk and Sifat.
                </div>
            </div>
        </footer>
    </div>
